...
export default function Footer() {
  return (
    <footer className="py-10 px-4 md:px-8 bg-white/95 dark:bg-[#0a0a0a] text-gray-700 dark:text-white mt-12 transition-colors duration-300 border-t border-gray-100 dark:border-gray-800">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex gap-6 order-2 md:order-1">
          <a 
            ...
            className="font-bold hover:text-primary transition-colors duration-300 uppercase text-xs tracking-widest text-gray-700 dark:text-white"
          >
            LinkedIn
          </a>
          <a 
